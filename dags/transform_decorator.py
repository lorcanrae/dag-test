...
def _prepare_data(bronze_file: str, date: str):
    """
...
def filter_long_trips(
    ...
    """
    - Calls _prepare_data to get a cleaned DataFrame
    ...
    """
    df = _prepare_data(bronze_file, date)
...
def transfrom():
    ...
    is_month_odd_task = is_month_odd(date)

    filter_long_trips_task = filter_long_trips(
    ...
    filter_expensive_trips_task = filter_expensive_trips(
        bronze_file=bronze_file,
        silver_file=silver_file,
        date=date,
        amount=500,
